...
module.exports = class extends Language {
    constructor() {
        ...
        this.language = {
            ...
            COMMAND_DJ_THRESHOLD_SET: (count) => `The DJ role requirement threshold has been changed.`,
            COMMAND_DJ_STATUS_SET: (state) => `DJ role ${state ? 'enabled' : 'disabled'}.`,
            COMMAND_SETTINGS_LIVEPLAYER_THUMBNAIL_LOCATION_SET: () => 'The location of the track icon has been changed.',
            COMMAND_SETTINGS_LIVEPLAYER_INVALID_COLOR: () => 'Wrong color specified.',
            COMMAND_SETTINGS_LIVEPLAYER_COLOR_SET: () => 'Live player embedded message color changed.',

            SETTINGS_LIVEPLAYER_THUMBNAIL_DESCRIPTION: () => 'Changes the position of the track icon',
            SETTINGS_LIVEPLAYER_THUMBNAIL_LOCATION_DESCRIPTION: () => 'Icon position (thumbnail/image/hide)',
            SETTINGS_LIVEPLAYER_COLOR_DESCRIPTION: () => 'Changes the color of an embed message',
            SETTINGS_LIVEPLAYER_COLOR_HEX_DESCRIPTION: () => 'Color in HEX format',
            SETTINGS_DJ_SET_DESCRIPTION: () => 'Sets the DJ role',
            SETTINGS_DJ_SET_ROLE_DESCRIPTION: () => 'Role',
            SETTINGS_DJ_THRESHOLD_DESCRIPTION: () => 'Sets the DJ role requirement threshold',
            SETTINGS_DJ_THRESHOLD_COUNT_DESCRIPTION: () => 'Number of users in the voice channel that will require the DJ role',
            SETTINGS_DJ_STATUS_DESCRIPTION: () => 'Enables or disables the DJ role',
            SETTINGS_DJ_STATUS_STATE_DESCRIPTION: () => 'State',
